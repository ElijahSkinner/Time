...
# getUser() Should only determine if the users name is in the spreadsheet or not.
def getUser():
...
if getUser():
    ...
    #Sheet1.append_row(fullName)
    sheet.add_worksheet(rows=20, cols=19, title=fullName)
    currentUserSheet = sheet.worksheet(fullName)
